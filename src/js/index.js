...
const ShowWeatherData = (e) => {
  e.preventDefault();
  const weatherInputVal = weatherInput.value;
  city.innerHTML = weatherInputVal;
};
...
const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=Lisbon&units=metric&appid=${apiKey}`;
